...
import WhatsappSVG from 'robotz/resources/images/whatsapp.svg'
  ...
  export default function Card({ title, image, price, priceMarket, children }: CardProps) {
    return (
      <Center margin={10}>
        <Box
          role="group"
        ...
        >
          ...
          <Stack pt={0} align="center">
            ...
            <Stack direction="row" w="full" align="center" justify="space-between">
              ...
              <Flex direction="column" align="end">
                ...
                <Text fontWeight={400} fontSize="11px" textTransform="uppercase" fontStyle="italic">
                  aceitamos bitcoin
                </Text>
              </Flex>
            </Stack>
